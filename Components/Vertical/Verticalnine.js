...
const Verticalnine = ({navigation}) => {
  ...
  return (
    <ImageBackground
      style={{flex: 1}}
      source={require('../../assets/images/Vertical/nine/Vbgnine.png')}>
      <View style={styles.maincontainer}>
        <View style={styles.one}>
          <Image
            style={styles.layernineimg}
            source={require('../../assets/images/Vertical/nine/Vlogo2trans.png')}></Image>
        </View>
